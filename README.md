...
### 7. 동적 추천 이유 문구가 맥락에 맞지 않게 생성되는 문제
...
### 9. 로컬 알림이 동작하지 않는 문제 — 패키지 버전 업그레이드로 해결
...
### 11. 광고 배너가 버튼 위에 겹쳐 조작을 방해하는 문제
...
### 12. 화면 회전 직후 버튼을 누르면 앱이 오류나거나 멈추는 문제
