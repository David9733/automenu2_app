...
2. GPT와 기능 방향을 논의하며 구체화
3. GPT에게 최종 개발용 프롬프트 생성 요청
...
**개발자 역할**: 기능 요구사항 정의, 기술 스택 선택, 성능 요구사항 결정 (캐시 유효 시간·한도 등), 비즈니스 로직 설계 (회식 조건 필터·추천 이유 구조 등), AI 결과물 검증 및 동작 판단, 배포 결정<br>
