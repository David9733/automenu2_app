...
- 아침·점심·저녁 식사 시간 선택 소개 
- 혼자·동료·연인·가족 상황 설정 소개 
- 음주 여부 고려한 맞춤 음식 필터링 소개 
- 한식·일식·양식·중식·분식 음식 종류 직접 선택 소개 
- 선택 조건 기반 음식 1~3개 개인화 추천 카드 제공 소개 
- 원하는 시간에 식사 알림 자동 설정 및 발송 소개 
- 다크·라이트 모드 전환 소개 
