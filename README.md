...
### 사전 요구사항
 ...
 Android: Android Studio, `google-services.json` (Firebase)<br>
 iOS: `GoogleService-Info.plist` (Firebase)<br>
 Supabase 프로젝트 URL 및 Anon Key: `lib/config/supabase_config.dart`
